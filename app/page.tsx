      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-base leading-7 text-ink/66">
            Elige un módulo de Winmotor Academy para continuar con la formación
            sobre ventas y taller, basada en vídeos oficiales y el Centro de Ayuda.
          </p>
        </div>
      </div>

      {/* Grid de módulos de Academy */}
          ...
          {homeModules.map((module) => (
            ...
            >
              <div>
                ...
                <p className="mt-1 text-xs text-ink/66">
                  {module.description}
                </p>
              </div>
              <p className="mt-3 text-xs font-medium text-ink/66">
                {module.videos.length} vídeos vinculados · {module.helpLinks.length} enlaces al Centro de Ayuda
              </p>
            </Link>
          ))}
        </div>
